/**
 * Association-circle report HTML export helpers (colocated for panel wiring; zero behavior).
 */
...
export function buildExportOrbitSnapshotHtml(
  centerTerm: string,
...
export function exportOrbitColor(groupKey: AssociationMapGroupKey) {
...
export function downloadAssociationReportHtml(
  centerTerm: string,
...
export function buildExportPeriodChangeHtml(periodView: Record<string, unknown> | null) {
...
export function renderExportParagraphHtml(text: string, entities: string[]): string {
