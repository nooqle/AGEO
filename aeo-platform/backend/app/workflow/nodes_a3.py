...
{{
  "questions": [
    {{
      ...
      "category": "问题分类（画像痛点场景/品牌直接问题/品类选购对比/行业趋势认知）",
...
## 问题分类比例（严格遵守）
- 画像痛点/场景问题 (35%)：基于画像人群的真实痛点、生活场景和需求，提出不包含品牌名的自然搜索问题
- 品牌直接问题 (30%)：直接提及品牌名称的认知、评价、对比类问题
- 品类选购对比 (20%)：围绕产品所属品类的选购建议、产品对比、排名推荐等，不限定是否提及品牌
- 行业趋势认知 (15%)：行业发展趋势、新技术、市场变化等宏观认知类问题
...
5. 避免重复或过于笼统的问题
6. 总问题数不超过 40 个
7. **重要**：严格按照上述比例分配问题类型。画像痛点/场景问题应模拟用户真实搜索习惯，用口语化表达，不要生硬地塞入品牌名"""
...
## 比例要求（务必遵守）
请严格按照以下比例生成问题：
- ~35% 画像痛点/场景问题：从画像人群的痛点和使用场景出发，用自然口语提问，**不要包含品牌名"{brand_name}"**
- ~30% 品牌直接问题：直接提及"{brand_name}"的问题
- ~20% 品类选购对比：围绕{industry}品类的选购、对比、推荐类问题
- ~15% 行业趋势认知：{industry}行业的趋势、技术、市场变化等问题
